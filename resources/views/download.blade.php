            ...
            <div class="grid grid-cols-1">
                <div class="p-6">
                    <div class="flex justify-center items-center">
                        <div class="text-lg items-center font-semibold">
                            <span class="mx-auto text-gray-900 dark:text-white">
                    ...
                    <div class="ml-12 mr-12">
                        <div class="mt-4 text-gray-600 dark:text-gray-400 text-sm">
                            <form method="POST" action="/con_download">
                                @csrf
                                <div>
