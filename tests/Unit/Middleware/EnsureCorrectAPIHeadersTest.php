...
class EnsureCorrectAPIHeadersTest extends TestCase
{
     ...
     * @test
     */
    public function when_aborting_for_a_missing_accept_header_the_correct_content_type_header_is_json_spec()
    {
        $request = Request::create('/test', 'GET');
        $middleware = new EnsureCorrectAPIHeaders;
        /** @var Response $response */
     ...
     * @test
     */
    public function when_aborting_for_a_missing_content_type_header_the_correct_content_type_header()
    {
        $request = Request::create('/test', 'POST');
        $request->headers->set('accept', 'application/vnd.api+json');
